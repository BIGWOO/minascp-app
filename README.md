...
本批不提供可用空間查詢、工作階段 URL／程式碼、命名工作區或隱藏標籤列；既有跨站台本機暫存容量檢查保留。驗收紀錄見 [分頁與資訊驗收](docs/tab-acceptance-20260910.md)。
...
- 日常右鍵實測見 [右鍵驗收紀錄](docs/context-menu-acceptance-20260910.md)；進階功能見 [跨站台與命令驗收](docs/advanced-acceptance-20260910.md)。
